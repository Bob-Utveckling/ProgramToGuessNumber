public class TestGuesser{
  ...
  public static void main(String[] args){
   //BL: test a set of guessers:
    Guesser guesser1 = new Guesser(1,500);
    Guesser guesser2 = new Guesser(1,1000);
    //Guesser guesser3 = new Guesser(1000,1); //throws IllegalArgumentException
